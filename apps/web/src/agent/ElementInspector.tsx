...
export default function ElementInspector({ scene, selected, locked, onSelect, onChange, onBusy }: Props) {
  ...
  function addMessage() {
    const m: Message = { id: crypto.randomUUID(), participantId: scene.selfId, type: 'text', text: '新消息', time: scene.deviceTime, ...(scene.referenceDate ? {date:scene.referenceDate} : {}) };
