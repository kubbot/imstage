...
export default function Workspace() {
  ...
  return <div className="workspace-shell">
    <aside className="workspace-sidebar"><span className="account-kicker">WORKSPACE</span><a href="#/workspace" className="workspace-nav active" aria-current="page"><IconLayoutGrid size={19} /> 我的作品</a><a href="#/templates" className="workspace-nav"><IconMessageCircle size={19} /> 场景灵感</a><a href="#/studio" className="workspace-nav"><IconEdit size={19} /> 本机草稿</a><a href="#/account" className="workspace-nav"><IconSettings size={19} /> 账号设置</a><div className="workspace-sidebar-note"><IconDeviceFloppy size={20} /><p>每一次保存，<br />都让灵感有迹可循。</p></div></aside>
