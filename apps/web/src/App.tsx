...
export default function App() {
  ...
  useEffect(() => { const title = route.page === '/create' ? '一句话创作' : route.page === '/studio' ? '工作台' : route.page === '/templates' ? '场景灵感' : route.page === '/docs' ? '使用与接入' : '一句话，聊到想象之外'; document.title = `IMStage · ${title}`; }, [route.page]);
  ...
  const valid = ['/', '/create', '/studio', '/templates', '/docs'].includes(route.page);
  ...
  </main>{!['/studio', '/create'].includes(route.page) && <Footer theme={theme} setTheme={updateTheme} />}</>;
}
